...
public class LikyController {
    ...
    public ResponseEntity<ResponseDto<String>> like(@AuthenticationPrincipal String userEmail, @PathVariable Integer boardId){
        return likyService.like(userEmail,boardId);
    }

    @GetMapping("/{boardId}/liky/get")
    public ResponseEntity<ResponseDto<List<LikyDto>>> getLiky(@PathVariable Integer boardId){
        return likyService.getLiky(boardId);
    }

    @GetMapping("/{boardId}/liky/get/count")
    public ResponseEntity<ResponseDto<Integer>> getLikyCount(@PathVariable Integer boardId){
