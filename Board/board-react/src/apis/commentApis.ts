...
export const editCommentApi = async (token: string | null, refreshToken: string | null, boardId: number, commentId: number, data: any) => {
    const url = `${testUrl}/api/board/${boardId}/comment/${commentId}/edit`
